...
public class CrashMe {
    ...
    @Test void baseline_singleEcall() throws Exception {
        assertTrue(service.someWork() > 0);
    }

    @Test void host_concurrentEcalls() throws Exception {
    ...
    @Test void enclave_gcPressureBgThread() throws Exception {
    ...
    @Test void enclave_dpSnapshotPattern() throws Exception {
    ...
    @Test void enclave_secureRandomBgThread() throws Exception {
    ...
    @Test void enclave_inlineThreadCompletion() throws Exception {
        assertEquals(6765, service.runInlineThread(20));
    }

    @Test void enclave_inlineThreadSynchronous() throws Exception {
        assertTrue(service.isInlineThreadSynchronous());
    }

    @Test void enclave_noZombieAfterInlineThread() throws Exception {
    ...
    @Test void enclave_concurrentInlineThreads() throws Exception {
        int hostThreads = 4, callsPerThread = 50, inlinePerCall = 5;
    ...
    @Test void host_coldStartStorm() throws Exception {
        int hostThreads = 64;
        CountDownLatch done = new CountDownLatch(hostThreads);
    ...
    @Test void host_sustainedThroughput() throws Exception {
    ...
    @Test void host_heterogeneousMix() throws Exception {
    ...
    @Test void host_threadChurn() throws Exception {
    ...
    @Test void host_cacheCapacitySaturation() throws Exception {
    ...
    @Test void host_concurrentLoadAndInvoke() throws Exception {
    ...
    @Test void host_destroyRacesEcalls() throws Exception {
    ...
    @Test void host_backToBackLifecycles() throws Exception {
